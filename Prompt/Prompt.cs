...
namespace Apex.Prompt
{
    public static class Prompt
    {
        ...
        /// <returns></returns>
        public static Tuple<string, bool> ShowStringBoolDialog(string Text, string Caption, string CheckText, string DefaultText = "", bool DefaultBool = false)
        {
            var prompt = new Form
            {
                Width = 500,
            ...
            checkBox.Dispose();
            prompt.Dispose();
            var values = new Tuple<string, bool>(textBox.Text, checkBox.Checked);
            return values;
        }
